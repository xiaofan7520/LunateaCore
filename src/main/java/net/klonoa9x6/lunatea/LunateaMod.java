...
@Mod("lunatea")
public class LunateaMod {
	public static final Logger LOGGER = LogManager.getLogger(LunateaMod.class);
	public static final String MODID = "lunatea";
